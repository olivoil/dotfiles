= Olivier Melcher's Dot Files - Forked from Ryan Bates (http://github.com/ryanb/dotfiles) then slightly modified.
...
== Installation
  ...
  git clone git://github.com/olivoil/dotfiles ~/.dotfiles
  cd ~/.dotfiles
  rake install
